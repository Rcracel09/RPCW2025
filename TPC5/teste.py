...
for id, name in data["allPeople"].items():
    rdf_output += f"""
###  http://www.semanticweb.org/gonca/ontologies/2025/cinema/{id}
...
"""
    ...
    for person in movie["peopleInvolved"]:
        ...
        rdf_output += f"""
###  http://www.semanticweb.org/gonca/ontologies/2025/cinema/{person_id}
...
with open("final_cinema.ttl", "w", encoding="utf-8") as ttl_file:
    ttl_file.write(rdf_output)
    print("Done, final file generated!")